...
export const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Identified the lack of end-to-end test coverage and led the initiative to close the gap by researching testing frameworks and selecting Patrol as the standard for e2e testing.',
      'Built a GitHub Actions workflow to run the e2e test suite nightly, including setting up and configuring an in-house Mac runner to support it.',
      'Designed and introduced standardized pull request templates, enhancing consistency and quality in code reviews across the team.',
      'Maintaining rigorous testing standards and achieving 90% code coverage across project packages.',
